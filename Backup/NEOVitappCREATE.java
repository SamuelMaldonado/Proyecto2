...
public class NEOVitapp
{
    ...
    public static void main( final String[] args )
    {
...

        {
            ...
            try ( Transaction tx = graphDb.beginTx() )
            {
                ...
                for ( int id = 0; id < 100; id++ )
                {
                    ...
                    userNode.setProperty( "username", "men13000" + id + "@uvg.edu.gt" );
                }
...

        {
            ...
            Label label = DynamicLabel.label( "User" );
            int idToFind = 40;
            String nameToFind = "men13000" + idToFind + "@uvg.edu.gt";
            try ( Transaction tx = graphDb.beginTx() )
            {
...

        {
            ...
            try ( Transaction tx = graphDb.beginTx() )
            {
                ...
                {
                    node.setProperty( "username", "men13000" + ( idToFind + 1 ) + "@uvg.edu.gt" );
                }
                tx.success();
            }
...

        {
            ...
            try ( Transaction tx = graphDb.beginTx() )
            {
                Label label = DynamicLabel.label( "User" );
                int idToFind = 41;
                String nameToFind = "menb13000" + idToFind + "@uvg.edu.gt";
